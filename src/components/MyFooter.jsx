const MyFooter = () => {
    ...
    return (
        <div className="row text-center mt-5 mx-5">
            <div classNameName="col-6 offset-3">
                <div className="row">
                    <div className="col col-12 text-left mb-2">
                        ...
                        <i className="fa fa-instagram footer-icon"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
